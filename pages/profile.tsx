...
const Profile = ({ tabBtns }: IProfilePageProps): JSX.Element => {
    ...
    <Layout>
      <section className="profile">
        ...
        <div className="container">
          ...
          <Link href="/profile/edit" className="profile__btn-edit">
            <svg
              width="12"
              height="13"
              viewBox="0 0 12 13"
          ...
          <Link href="" className="profile__btn-edit disabled">
            <svg
              width="14"
              height="14"
              viewBox="0 0 14 14"
          ...
          <div className="profile__body">
            <div className="tabs profile__tabs">
              <div className="tabs__body profile__body">
                <div className="tabs__nav profile__nav">
                  {tabBtns &&
                    tabBtns.map((tabBtn, idx) => (
                      <button
                        key={tabBtn.id}
                        className={`tabs__btn profile__btn ${
                          tabIndex === idx ? "tabs__btn--active" : ""
                        }`}
                        onClick={() => changeTabIndex(idx)}
                      >
                        {tabBtn.label}
                      </button>
                    ))}
                </div>
                <div className="tabs__content">{tabShow()}</div>
              </div>
            </div>
          </div>
        </div>
...
const TabProjects = () => {
  return (
    <div
      id="profile__panel-1"
      className="tabs__panel profile__panel tabs__panel--active"
    >
      <div className="profile__help-users">
        ...
        <div className="help-card">
          ...
          <div className="help-card__body">
            <div className="help-card__user">
              <div className="help-card__avatar">
                <picture>
                  <source srcSet="/uploads/.webp" type="image/webp" />
                  <img src="/uploads/" alt="" />
                </picture>
                <svg
                  width="33"
          ...
          <div className="help-card__footer">
            ...
            <a href="/project.php?id=24" className="help-card__more">
...
const TabChecks = () => {
  return (
    <div id="profile__panel-2" className="tabs__panel  profile__panel">
      <div className="check-profile">
        <div className="check-profile__body">
          ...
          <div className="check-profile__img">
            <picture>
              <source srcSet="/img/check-profile.webp" type="image/webp" />
...
const TabInfo = () => {
  return (
    <div id="profile__panel-3" className="tabs__panel profile__panel">
